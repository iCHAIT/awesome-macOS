...
- [MetaClean](https://github.com/Moresyl/metaclean) - Remove metadata from images, Office documents, PDFs, and text files entirely offline. [![Open-Source Software][OSS Icon]](https://github.com/Moresyl/metaclean) ![Freeware][Freeware Icon]
