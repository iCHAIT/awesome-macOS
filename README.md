...
- [Mole Widget](https://github.com/bsnkhua/mole-widget) - Lightweight system monitor for the menu bar with live CPU, memory, disk, network, battery, and process metrics. [![Open-Source Software][OSS Icon]](https://github.com/bsnkhua/mole-widget) ![Freeware][Freeware Icon]
