...
- [ModelStatus](https://github.com/lucasmullikin/ModelStatus) - Menu bar monitor for multiple local LLM servers (Ollama, LM Studio, vLLM, MLX, llama.cpp). Multi-instance, auto-provider-detect, LAN + Tailscale discovery, no telemetry. [![Open-Source Software][OSS Icon]](https://github.com/lucasmullikin/ModelStatus) ![Freeware][Freeware Icon]
