...
- [PinboardShot](https://pinboardshot.agentclub.dev) - Native, local-first macOS screenshot, annotation, scrolling capture, OCR history, and screen pinboard app. [![Open-Source Software][OSS Icon]](https://github.com/agent-club/PinboardShot) ![Freeware][Freeware Icon]
