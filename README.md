...
- [Inscribe](https://get-inscribe.com) - Records and transcribes meetings, lectures, and interviews entirely on-device using local speech models, with no cloud upload.
