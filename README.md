...
- [Hop](https://hop.tools) - Sixteen everyday tools in one menu bar panel: timer, time tracker, keep-awake, system monitor, clipboard history, file converter, window layouts, text recognition and more, with unused modules switched off. [![Open-Source Software][OSS Icon]](https://github.com/antonyshakirov/hop) ![Freeware][Freeware Icon]
