...
- [OpenMapTiles](https://openmaptiles.org/) - OpenMapTiles is a set of open-source tools for self-hosting of OpenStreetMaps. It provides both raster as well as vector tiles, WMS, WMTS, support for JavaScript viewers, mobile SDK and support for more than 50 languages. [![Open-Source Software][OSS Icon]](https://github.com/openmaptiles)
