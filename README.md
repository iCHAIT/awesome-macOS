...
- [Hangar](https://github.com/0fuz/hangar) - Menu bar launcher for one-click, toggleable terminal and app snippets. [![Open-Source Software][OSS Icon]](https://github.com/0fuz/hangar) ![Freeware][Freeware Icon]
