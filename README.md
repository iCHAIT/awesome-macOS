...
- [Atom](https://atom.io/) - Text editor that's modern, approachable, yet hackable to the core. [![Open-Source Software][OSS Icon]](https://github.com/coteditor/CotEditor/) ![Freeware][Freeware Icon]
