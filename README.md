...
- [Core-Monitor](https://github.com/offyotto-sl3/Core-Monitor) - A system monitor for Apple Silicon Macs with menu bar stats, SMC sensor readings, and fan control. v12 is officially notarized. [![Open-Source Software][OSS Icon]](https://github.com/offyotto-sl3/Core-Monitor) ![Freeware][Freeware Icon]
